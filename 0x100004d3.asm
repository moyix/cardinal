...
main:
	...
	;; initialization
	MOV EAX, 00403000H
  MOV DWORD [EAX], 0AFCFEF3FH
  MOV DWORD [EAX+4], 0FFCF1F4FH
  MOV DWORD [EAX+8], 07F0FFF1FH
  MOV DWORD [EAX+0CH], 0FF3FF3FFH
  MOVDQU XMM0, OWORD [EAX]
  MOV DWORD [EAX], 0F23C5678H
  MOV DWORD [EAX+8], 0B87ACDEFH
  MOVDQU XMM1, OWORD [EAX]
  MOVDQU XMM2, OWORD [EAX+8]
 int3
